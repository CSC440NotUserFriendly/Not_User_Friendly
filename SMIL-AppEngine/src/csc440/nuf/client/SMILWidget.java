...
import csc440.nuf.client.MyRequestFactory.MessageRequest;
import csc440.nuf.shared.MessageProxy;

public class SMILWidget extends Composite {
  ...
  interface SMILUiBinder extends UiBinder<Widget, SMILWidget> {
  }

  private static SMILUiBinder uiBinder = GWT.create(SMILUiBinder.class);
