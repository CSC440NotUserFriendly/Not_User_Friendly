...
import com.csc440nuf.client.MyRequestFactory.HelloWorldRequest;
import com.csc440nuf.client.MyRequestFactory.MessageRequest;
import com.csc440nuf.shared.MessageProxy;

public class Csc440nufWidget extends Composite {
  ...
  interface Csc440nufUiBinder extends UiBinder<Widget, Csc440nufWidget> {
  }

  private static Csc440nufUiBinder uiBinder = GWT.create(Csc440nufUiBinder.class);
