...
public class ScrollItem extends RelativeLayout {
	...
	public ScrollItem(Context context, AttributeSet attrs) {
		...
		RelativeLayout barView = (RelativeLayout) mInflater.inflate(R.layout.scroll_item, null);
		addView(barView);
		...
		mTitleView = (TextView) barView.findViewById(R.id.title);
		mTitleView.setText("This is example text to put inside this thing majigggg.");
		mActionIconContainer = (LinearLayout) barView.findViewById(R.id.linear);
